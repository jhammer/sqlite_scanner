...
string SqliteFilterPushdown::CreateExpression(string &column_name, vector<unique_ptr<TableFilter>> &filters, string op) {
...
string SqliteFilterPushdown::TransformComparision(ExpressionType type) {
	switch (type) {
...
string SqliteFilterPushdown::TransformFilter(string &column_name, TableFilter &filter) {
...
string SqliteFilterPushdown::TransformFilters(const vector<column_t> &column_ids, optional_ptr<TableFilterSet> filters, const vector<string> &names) {
